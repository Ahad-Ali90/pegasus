...
<head>
  ...
  <title>Hourly Hire | Pegasus Transfers</title>
...
.estimator {
  background: linear-gradient(135deg, #ffffff, #fef4e9);
  padding: 40px 20px;
  border-radius: 15px;
  max-width: 500px;
  margin: 40px auto;
...
.estimator select {
  ...
  box-shadow: 0 4px 12px rgba(243, 124, 6, 0.2);
}

.estimator select:focus {
  border-color: #f5ab61;
  box-shadow: 0 0 10px #f5ab61;
}

.estimator .rate-display {
  margin-top: 25px;
  font-size: 2.2rem;
  color: #f37c06;
  font-weight: bold;
...
.estimator .rate-display:hover {
  transform: scale(1.1);
  color: #e65c00;
  text-shadow: 0 0 10px rgba(243, 124, 6, 0.3);
}
...
.hand {
  display: inline-block;
  animation: handMove 1.2s infinite ease-in-out;
  font-size: 20px;
}
...
<section class="hero">
 <div class="hero-image">
  ...
  <!-- Clear Image (centered) -->
  <img src="images/hourlyhiring.jpg" alt="By the Hour Service">
</div>

  <div class="left-hero-text">
    <p>Hourly Hire – Set Your Itinerary & Enjoy Freedom</p>
  </div>
...
<script>
  ...
  <section class="cards">
    <div class="card">
      ...
      <h3>Set Your Itinerary</h3>
      <p>Choose your stops, timing and flow—you're in full control.</p>
    </div>
    <div class="card">
      <i class="fas fa-clock"></i>
      <h3>Save Time & Relax</h3>
      <p>No waiting. No rushing. Just seamless travel at your pace.</p>
    </div>
    <div class="card">
      <i class="fas fa-wifi"></i>
      <h3>Stay Connected</h3>
      <p>Most vehicles include Wi‑Fi so you can work or browse on-the-go.</p>
    </div>
  </section>
 ...
 <section class="steps">
  <div class="step-content">
    ...
    <div class="step-cards">
      <div class="step-box">
        <span>1</span>
        <p>Choose your pickup & destination locations.</p>
      </div>
      <div class="step-box">
        <span>2</span>
        <p>Select your vehicle & hire duration.</p>
      </div>
      <div class="step-box">
        <span>3</span>
        <p>Enter passenger details & confirm your booking.</p>
      </div>
      <div class="step-box">
        <span>4</span>
        <p>Enjoy your Ride.</p>
  ...
  <div class="step-image">
    <img src="images/1service.jpg" alt="Steps Illustration" />
  </div>
</section>


<div class="estimator">
 <p class="dropdown-tip">
   <h3>Estimate Hourly Rate</h3>
  <div><span class="hand">👇 Tap below to check your Hourly rate</p></div>
  <select onchange="updateRate(this)">
    <option value="50">Saloon Car – £50/hr</option>
    <option value="55">Estate Car – £55/hr</option>
    <option value="60">MPV-6 – £60/hr</option>
    <option value="50">Executive Car – £60/hr</option>
    <option value="80">8 Seater – £80/hr</option>
    <option value="90">9 Seater – £90/hr</option>
  </select>
  <div class="rate-display" id="rateValue">£30/hr</div>
</div>
  ...
  function updateRate() {
    ...
    rateDisplay.textContent = "Hourly Rate: " + rates[selected];

    // Add flash animation
    rateDisplay.classList.remove("flash");
    void rateDisplay.offsetWidth; // Trigger reflow
    rateDisplay.classList.add("flash");
  }
</script>
