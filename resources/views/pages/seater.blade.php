...
<body>
 ...
 <div class="container">
  ...
  <a href="homepage.html">← Back to Home</a>
    ...
    <h1 style="  font-family: 'Playfair Display', serif;">9‑Seater Minibus</h1>

    <img src="images/haya-removebg-preview.png" alt="9‑Seater Minibus" class="car-image" />

    <div class="description">
      <p>The 9‑Seater Minibus is the ultimate choice for larger groups traveling together. Whether for a corporate outing, a family trip, or airport transfer with lots of luggage, this vehicle offers unmatched comfort and space.</p>
    </div>
...
<i class="fas fa-suitcase-rolling"></i>
        <h4>Luggage</h4>
        <p>12 carry-on bags or 12 standard check-in or 6 extra Large check-in bags</p>
      </div>
      <div class="feature-box">
 <i class="fas fa-snowflake"></i>
        <h4>Comfort</h4>
        <p>Airy interior, USB ports, Leather seats</p>
      </div>
      <div class="feature-box">
<i class="fas fa-star"></i>
        <h4>Great For</h4>
        <p>Events, airport groups, tours</p>
      </div>
    </div>

    <button class="toggle-info" onclick="toggleInfo()">Show More Details</button>
    <div class="extra-info" id="moreInfo">
      <p>Minibuses are perfect for group bookings with generous space for luggage and legroom. Equipped with modern safety and comfort features, our minibuses ensure a stress-free group journey.</p>
    </div>
