...
<body>
 ...
 <div class="container">
  ...
  <a href="homepage.html">← Back to Home</a>
    ...
    <h1 style="  font-family: 'Playfair Display', serif;">MPV 6-Seater</h1>

    <img src="images/mpv7seaters2-removebg-preview.png" alt="MPV 6-Seater" class="car-image" />

    <div class="description">
      <p>The MPV 6-Seater is perfect for small groups, families, or business travelers requiring extra space and comfort. Vehicles like the Ford Galaxy or Volkswagen Sharan are commonly used and come with spacious interiors and dual sliding doors.</p>
    </div>
    ...
    <div class="features">
      ...
      <div class="feature-box">
        ...
        <h4>Luggage</h4>
        <p>6 carry-ons or 4 check-in or 4 large suitcases</p>
      </div>
      <div class="feature-box">
        <i class="fas fa-snowflake"></i>
        <h4>Features</h4>
        <p>Sliding doors, rear AC, USB ports</p>
      </div>
      <div class="feature-box">
        <i class="fas fa-star"></i>
        <h4>Ideal For</h4>
        <p>Group travel, airport runs, family trips</p>
      </div>
    </div>

    <button class="toggle-info" onclick="toggleInfo()">Show More Details</button>
    <div class="extra-info" id="moreInfo">
      <p>The MPV 6-Seater provides easy access with sliding doors and a flat floor. It’s a popular choice for airport journeys or cruise transfers, offering enough room for both people and their luggage. Optional extras like booster seats or extra boot space can be requested.</p>
    </div>
...
<div class="interactive-cards">
  <div class="card" data-img="1mpv.png">
  ...
  <div class="card" data-img="2mpv.png">
    <div class="card-content">
      <i class="fas fa-suitcase-rolling"></i>
      <h3>5 Carry-on</h3>
  ...
  <div class="card" data-img="3mpv.png">
    <div class="card-content">
      <i class="fas fa-suitcase-rolling"></i>
      <h3>3 Extra-Large </h3>
