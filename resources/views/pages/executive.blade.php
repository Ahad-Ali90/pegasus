...
<body>
  ...
  <a href="homepage.html">← Back to Home</a>
    ...
    <h1 style="  font-family: 'Playfair Display', serif;">Executive Car</h1>

    <img src="images/exective car.png" alt="Executive Car" class="car-image" />

    <div class="description">
      <p>The Executive Car class provides a premium ride for business travelers and those seeking luxury and sophistication. With vehicles like the Mercedes E-Class, BMW 5 Series, and Audi A6, you can expect superior comfort, quiet cabins, and professional appearance.</p>
    </div>
    ...
    <div class="features">
      ...
      <div class="feature-box">
        ...
        <h4>Luggage</h4>
        <p>2 standard check-in or 2 carry-on bags or 1 large suitcase</p>
      </div>
      <div class="feature-box">
        <i class="fas fa-snowflake"></i>
        <h4>Luxury Interior</h4>
        <p>Leather seats, climate control, tinted privacy windows</p>
      </div>
      <div class="feature-box">
        <i class="fas fa-star"></i>
       
        <h4>Business Preferred</h4>
        <p>Perfect for corporate clients and VIP transfers</p>
      </div>
    </div>

    <button class="toggle-info" onclick="toggleInfo()">Show More Details</button>
    <div class="extra-info" id="moreInfo">
      <p>Executive Cars are maintained at the highest standard and regularly sanitized. These vehicles come with a professional chauffeur dressed in formal attire, and water or refreshments can be made available on request.</p>
    </div>
<div style="height: 30px;"></div>
 <!-- Luggage Capacity Guidance Section -->
...
<div class="interactive-cards">
  <div class="card" data-img="S1.png">
     <div class="card-bg"></div> <!-- ✅ ADD THIS LINE -->
    <div class="card-content">
      <i class="fas fa-suitcase-rolling"></i>
      <h3>1 Small - 2 Medium</h3>
      <p>Ideal for short city trips with.</p>
    </div>
  </div>
  <div class="card" data-img="S2.png">
    <div class="card-content">
      <i class="fas fa-suitcase-rolling"></i>
      <h3>1 Large - 1 Medium</h3>
      <p>Perfect for airport rides with medium luggage.</p>
    </div>
  </div>
  <div class="card" data-img="S3.png">
    <div class="card-content">
      <i class="fas fa-suitcase-rolling"></i>
      <h3>1 Extra-Large - 1 Small</h3>
      <p>Great for corporate travel with hand luggage.</p>
    </div>
  </div>
  <div class="card" data-img="S4.png">
    <div class="card-content">
      <i class="fas fa-suitcase-rolling"></i>
     <h3>2 large</h3>
      <p>Best for couples or solo travelers.</p>
    </div>
  </div>
</div>
